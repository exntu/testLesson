							...
							url : _ctx + '/service/card/today'
								...
								.success(
										function(data, status, headers, config) {
											...
											// var selectCardAlready =
											// data.selectCardAlready;
											// card shade
											...
											function remain() {
												now
														.setSeconds(now
																.getSeconds() + 1);
												var remainHour = 23 - now
														.getHours();
												var remainMin = 59 - now
														.getMinutes();
												var remainSec = 59 - now
														.getSeconds();
												var remain = (("0" + remainHour)
														.slice(-2))
														+ ":"
														+ (("0" + remainMin)
																.slice(-2))
											...
											for (var num = 0; num < selectFirstCard.length; num++) {
												...
												if (selectFirstCard[num].classify == "LAN") {
													...
													$scope.firstAge = ageFirst > 50 ? "50대 이상"
															: (ageFirst > 40 ? "40대"
																	: (ageFirst > 30 ? "30대"
																			: (ageFirst > 20 ? "20대"
																					: "20대 이하")));
											...
											for (var num = 0; num < selectSecondCard.length; num++) {
												...
												if (selectSecondCard[num].classify == "LAN") {
													...
													$scope.secondAge = ageSecond > 50 ? "50대 이상"
															: (ageSecond > 40 ? "40대"
																	: (ageSecond > 30 ? "30대"
																			: (ageSecond > 20 ? "20대"
																					: "20대 이하")));
											...
											for (var num = 0; num < firstHistory.length; num++) {
												...
												if (firstHistory[num].classify == "LAN") {
													...
													$scope.firstHistoryAge = ageFirst > 50 ? "50대 이상"
															: (ageFirst > 40 ? "40대"
																	: (ageFirst > 30 ? "30대"
																			: (ageFirst > 20 ? "20대"
																					: "20대 이하")));
											...
											var firstHistoryDate = new Date(
													firstHistory[0].createDT);
											$scope.firstMonth = firstHistoryDate
													.getMonth() + 1;
											$scope.firstDay = firstHistoryDate
													.getDate();
											...
											for (var num = 0; num < secondHistory.length; num++) {
												...
												if (secondHistory[num].classify == "LAN") {
													...
													$scope.secondHistoryAge = agesecond > 50 ? "50대 이상"
															: (agesecond > 40 ? "40대"
																	: (agesecond > 30 ? "30대"
																			: (agesecond > 20 ? "20대"
																					: "20대 이하")));
											...
											var secondHistoryDate = new Date(
													secondHistory[0].createDT);
											$scope.secondMonth = secondHistoryDate
													.getMonth() + 1;
											$scope.secondDay = secondHistoryDate
													.getDate();
											...
											for (var num = 0; num < thirdHistory.length; num++) {
												...
												if (thirdHistory[num].classify == "LAN") {
													...
													$scope.thirdHistoryAge = agethird > 50 ? "50대 이상"
															: (agethird > 40 ? "40대"
																	: (agethird > 30 ? "30대"
																			: (agethird > 20 ? "20대"
																					: "20대 이하")));
											...
											var thirdHistoryDate = new Date(
													thirdHistory[0].createDT);
											$scope.thirdMonth = thirdHistoryDate
													.getMonth() + 1;
											$scope.thirdDay = thirdHistoryDate
													.getDate();
											...
											for (var num = 0; num < forthHistory.length; num++) {
												...
												if (forthHistory[num].classify == "LAN") {
													...
													$scope.forthHistoryAge = ageforth > 50 ? "50대 이상"
															: (ageforth > 40 ? "40대"
																	: (ageforth > 30 ? "30대"
																			: (ageforth > 20 ? "20대"
																					: "20대 이하")));
											...
											var forthHistoryDate = new Date(
													forthHistory[0].createDT);
											$scope.forthMonth = forthHistoryDate
													.getMonth() + 1;
											$scope.forthDay = forthHistoryDate
													.getDate();
											...
											$scope.clickHistorySelect = function(
													email) {
